  ...
  .nav-link span {
    font-size: 16px;
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "INSERT INTO perfume (name, descricao, preco, imagem, video, estoque)
...
<body>
  ...
  <form method="POST" action="add_perfume.php" enctype="multipart/form-data" class="product-form">
    <div class="form-group">
        <label for="nome">Nome do Perfume & Cosméticos de Mulheres</label>
        <input type="text" name="name" id="nome" placeholder="Perfume & Cosméticos de Mulheres" required>
    </div>

    <div class="form-group">
        <label for="descricao">Descrição do Perfume & Cosméticos de Mulheres</label>
        <textarea name="descricao" id="descricao" placeholder="Descrição de Perfume & Cosméticos de Mulheres" rows="4" required></textarea>
    </div>
      ...
      <div class="row">
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  // Botão de Eliminar
                  echo "<form method='POST' action='delete_perfume.php' style='display: inline;'>";
