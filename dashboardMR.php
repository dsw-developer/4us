  ...
  .nav-link span {
    font-size: 16px;
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "INSERT INTO roupasm (name, descricao, preco, img)
...
<body>
  ...
  <form method="POST" action="add_roupaM.php" enctype="multipart/form-data" class="product-form">
    <div class="form-group">
        <label for="nome">Nome dos Vestuários de Mulheres</label>
        <input type="text" name="name" id="nome" placeholder="Vestuários de Mulheres" required>
    </div>

    <div class="form-group">
        <label for="descricao">Descrição dos Vestuários de Mulheres</label>
        <textarea name="descricao" id="descricao" placeholder="Descrição de Vestuários de Mulheres" rows="4" required></textarea>
    </div>
      ...
      <div class="row">
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  // Botão de Eliminar
                  echo "<form method='POST' action='delete_roupaM.php' style='display: inline;'>";
