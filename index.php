...
<body>
    ...
    <div class="nav-menu" id="navMenu">
        ...
        <div class="submenu">
            ...
            <a href="roupaM.php">Vestuários</a>
        ...
        <section id="products" class="products-section">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    $whatsapp_message = "Olá, gostaria de comprar o produto: " . htmlspecialchars($row['nome']) . "%0A";
                    $whatsapp_message .= "Preço: Kz " . htmlspecialchars($row['preco']) . "%0A";
                    $whatsapp_message .= "Imagem:https://4us.ct.ws/" . urlencode(htmlspecialchars($row['imagem'])) . "%0A";
                    ...
                    echo "<img src='" . htmlspecialchars($row['imagem']) . "' alt='" . htmlspecialchars($row['nome']) . "' class='product-img'>";
