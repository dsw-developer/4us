  ...
  .nav-link span {
    font-size: 16px;
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "INSERT INTO tenism (name, descricao, preco, img, video, estoque)
...
<body>
  ...
  <form method="POST" action="add_tenisM.php" enctype="multipart/form-data" class="product-form">
    <div class="form-group">
        <label for="nome">Nome dos Calçados</label>
        <input type="text" name="name" id="nome" placeholder="Calçados para Mulheres" required>
    </div>

    <div class="form-group">
        <label for="descricao">Descrição dos Calçados</label>
        <textarea name="descricao" id="descricao" placeholder="Descrição para Calçados de Mulheres" rows="4" required></textarea>
    </div>
    ...
    <button type="submit" class="btn-submit">Adicionar Produto de Homem</button>
</form>
      ...
      <div class="row">
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  // Botão de Eliminar
                  echo "<form method='POST' action='delete_tenisM.php' style='display: inline;'>";
