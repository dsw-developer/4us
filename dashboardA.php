...
<ul class="nav flex-column">
  <li class="nav-item mb-2">
    <a href="dashboard.php" class="nav-link sidebar-link d-flex align-items-center">
  ...
  <li class="nav-item mb-2">
    <a href="dashboardR.php" class="nav-link sidebar-link d-flex align-items-center">
  ...
  <li class="nav-item mb-2">
    <a href="dashboardT.php" class="nav-link sidebar-link d-flex align-items-center">
  ...
  <li class="nav-item mb-2">
    <a href="dashboardA.php" class="nav-link sidebar-link d-flex align-items-center">
...
<body>
  ...
  <form method="POST" action="add_acessorios.php" enctype="multipart/form-data" class="product-form">
    <div class="form-group">
        <label for="nome">Nome do Acessórios</label>
        <input type="text" name="name" id="nome" placeholder="Acessórios" required>
    </div>

    <div class="form-group">
        <label for="descricao">Descrição do Acessórios</label>
        <textarea name="descricao" id="descricao" placeholder="Descrição dos Acessórios" rows="4" required></textarea>
    </div>
      ...
      <div class="row">
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  // Botão de Eliminar
                  echo "<form method='POST' action='delete_acessorio.php' style='display: inline;'>";
