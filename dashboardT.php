  ...
  .nav-link span {
    font-size: 16px;
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "INSERT INTO tenis (name, descricao, preco, img, video, estoque)
...
<body>
  ...
  <form method="POST" action="add_tenis.php" enctype="multipart/form-data" class="product-form">
    <div class="form-group">
        <label for="nome">Nome dos Calçados</label>
        <input type="text" name="name" id="nome" placeholder="Calçados" required>
    </div>

    <div class="form-group">
        <label for="descricao">Descrição dos Calçados</label>
        <textarea name="descricao" id="descricao" placeholder="Descrição dos Calçados" rows="4" required></textarea>
    </div>
      ...
      <div class="row">
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  // Botão de Eliminar
                  echo "<form method='POST' action='delete_tenis.php' style='display: inline;'>";
