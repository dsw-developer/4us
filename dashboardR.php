  ...
  .nav-link span {
    font-size: 16px;
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql = "INSERT INTO usuarios (name, Descricao, preco, img, video, estoque)
...
<body>
  ...
  <form method="POST" action="add_roupa.php" enctype="multipart/form-data" class="product-form">
    <div class="form-group">
        <label for="nome">Nome dos Vestuários</label>
        <input type="text" name="name" id="name" placeholder="Vestuários" required>
    </div>

    <div class="form-group">
        <label for="descricao"> Descrição do Vestuários</label>
        <textarea name="Descricao" id="Descricao" placeholder="Descrição do Vestuários" rows="4" required></textarea>
    </div>
      ...
      <div class="row">
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  // Botão de Eliminar
                  echo "<form method='POST' action='delete_roupa.php' style='display: inline;'>";
